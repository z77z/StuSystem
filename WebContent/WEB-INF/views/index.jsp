	...
	BUI.use('common/main',function(){
      var config = [{
          ...
          menu:[{
              text:'学生操作',
              items:[
                {id:'cjcx',text:'成绩查询',href:'/StuSystem/score/xsgrcjcx?studentId=' + '${userbean.userId}'},
                {id:'xsgrkcgl',text:'学生个人课程管理',href:'/StuSystem/score/scoreone?page=1&studentId=' + '${userbean.userId}' },
				{id:'xsgrxxgl',text:'学生个人信息管理',href:'/StuSystem/student/studentone?stuId=' + '${userbean.userId}' },
	...
	BUI.use('common/main',function(){
      var config = [{
          ...
          menu:[{
              text:'教师操作',
              items:[
                {id:'xsxxgl',text:'学生信息管理',href:'/StuSystem/teacher/teacherlist?page=1'},
                {id:'kcxxgl',text:'课程信息管理',href:'/StuSystem/student/studentlist?page=1'},
				{id:'jsgrxxgl',text:'教师个人信息管理',href:'/StuSystem/teacher/teacherone?teacherId='+'${userbean.userId}'},
				{id:'xscjgl',text:'学生成绩管理',href:'/StuSystem/score/scorelist?page=1'},
				{id:'dlmmxg',text:'登录密码修改',href:'/StuSystem/user/dlmmxg'},
				{id:'gy',text:'关于',href:'gy'}
              ]
            }]
	      ...
	      var config = [{
	          ...
	          menu:[{
	              ...
	              items:[
	                ...
	                {id:'xsxxgl',text:'学生信息管理',href:'/StuSystem/student/studentlist?page=1'},
	                {id:'kcxxgl',text:'课程信息管理',href:'/StuSystem/subject/subjectlist?page=1'},
	                {id:'xscjgl',text:'学生成绩管理',href:'/StuSystem/score/scorelist?page=1'},
					{id:'dlmmxg',text:'登录密码修改',href:'/StuSystem/user/dlmmxg'},
					{id:'gy',text:'关于',href:'gy'}
	              ]
